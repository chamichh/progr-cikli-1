...
if r.status_code == 200:
	...
	# Produces a list of safe and dangerous asteroids after iterating through the data.
	if 'element_count' in json_data:
		...
		if ast_count > 0:
			for val in json_data['near_earth_objects'][request_date]:
				...
				# Determines whether the aster is dangerous 
				if 'name' and 'nasa_jpl_url' and 'estimated_diameter' and 'is_potentially_hazardous_asteroid' and 'close_approach_data' in val:
					...
					#Determines if there are any asterioids that are going to aproach us up close
	...
	# Determines whether an asteroid will pass Earth today. 
